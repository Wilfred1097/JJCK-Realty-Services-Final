...
function App() {
  ...
  const getRandomImage = () => {
    ...
    const imageUrls = [
      'https://t4.ftcdn.net/jpg/00/86/79/15/240_F_86791518_rQZ4pYogBmAIzzOUj4un1oSAThBcMjL4.jpg',
      'https://t4.ftcdn.net/jpg/01/15/23/79/240_F_115237993_GYjbk7VST3MJkRGR09fUYPDQBXZr6rXD.jpg',
      'https://t3.ftcdn.net/jpg/02/09/08/88/240_F_209088870_LmEXoVaScTo7HsCpfmZDu2B2vDL3VRng.jpg',
    ];
      ...
      <Container className="mt-5" id='listing'fluid>
        ...
        <Row>
          <Col className='text-center'>
            <a href="/listings"style={{ textDecoration: 'none' }}><h4>More Listings</h4></a>
          </Col>
        </Row>
      </Container>
      {/* End of Listing */}
